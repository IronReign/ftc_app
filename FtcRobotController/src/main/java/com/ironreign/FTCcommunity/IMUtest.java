...
public class IMUtest extends OpMode {
  ...
  public void init() {
    ...
    try {
      boschBNO055 = new AdafruitIMU(hardwareMap, "bno055b", "cdim", 5
  ...
  public void loop() {
    ...
    telemetry.addData("heading(yaw) angle", String.format("%d, Hex: 0X%04X, %4.4f",
      headingAngle, headingAngle, ((double)headingAngle / 16.0)));

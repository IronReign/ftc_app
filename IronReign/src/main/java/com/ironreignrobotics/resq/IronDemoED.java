...
import com.ironempire.util.Pose;
 ...
 */
@TeleOp(name="6832 Demo (ED)", group="IronReign")
//@Disabled
public class IronDemoED extends OpMode
    {
    ...
    protected long systemTime;//Relevant values of System.nanoTime
...
*/
            ...
            // SyncOpmode would need this: Emit telemetry with the freshest possible values

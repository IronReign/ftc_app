...
public class PosePele
{
     ...
     */
    public PosePele(double x, double y, double heading, double speed, DcMotor flingLeft, DcMotor flingRight)
    {
     ...
     */
    public PosePele(double x, double y, double angle, DcMotor flingLeft, DcMotor flingRight)
    {
     ...
     */
    public PosePele(DcMotor flingLeft, DcMotor flingRight)
    {

...
*/
    ...
    protected void main() throws InterruptedException {
        ...
        this.motorLeftRear.setMode(DcMotorController.RunMode.RUN_WITHOUT_ENCODERS);
        this.motorRightRear.setMode(DcMotorController.RunMode.RUN_WITHOUT_ENCODERS);
...
*/
      ...
      //  float powerLeft = Range.clip(ctlLeft - ctlRight, -1f, 1f);
        ...
        this.motorLeftRear.setPower(ctlLeft);
        this.motorRightRear.setPower(ctlRight);
    }
